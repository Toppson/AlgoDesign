...
#     print("Positive words are:",text_list_links(positiveword[l]))
#     print("Negative words are:",text_list_links(negativeword[l]))
#     print("Neutral words are:",text_list_links(neutralword[l]))
